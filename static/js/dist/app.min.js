...
"use strict";var _game=require("./game"),_player=require("./player"),$=require("jquery");$(document).ready(function(){var e=new _game.TicTacToe;console.log(e)});
},{"./game":3,"./player":4,"jquery":1}],3:[function(require,module,exports){
"use strict";function _classCallCheck(e,s){if(!(e instanceof s))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,s){for(var t=0;t<s.length;t++){var i=s[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(s,t,i){return t&&e(s.prototype,t),i&&e(s,i),s}}();Object.defineProperty(exports,"__esModule",{value:!0});var $=require("jquery"),TicTacToe=exports.TicTacToe=function(){function e(){_classCallCheck(this,e),this.board=$("#board"),this.positions=this.board.find("td"),this.message=$(".msg"),this.instructions=$(".instructions"),this.newGameControls=$(".new-game-controls"),this.resetControls=$(".reset-controls"),this.winningCombos=[[1,2,3],[4,5,6],[7,8,9],[1,4,7],[2,5,8],[3,6,9],[1,5,9],[3,5,7]],e.sides={x:'<i class="fa fa-remove"></i>',o:'<i class="fa fa-circle-o"></i>'},this.resetControls.find(".btn").on("click",function(){this.reset()}),this.reset()}return _createClass(e,[{key:"reset",value:function(){this.resetControls.hide(),this.newGameControls.show(),this.board.removeClass("tie active"),this.message.html(""),this.instructions.html(""),this.positions.html("").removeClass("selected win")}}]),e}();
},{"jquery":1}],4:[function(require,module,exports){
"use strict";function _classCallCheck(s,e){if(!(s instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var Player=exports.Player=function s(e){_classCallCheck(this,s),this.fullName=e.fullName||"Player 1",this.isAI=e.isAI||!1,this.positions=[],this.side=null,this.winner=!1};
},{}]},{},[2])
