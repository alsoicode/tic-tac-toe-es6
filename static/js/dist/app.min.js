...
"use strict";var _game=require("./game"),$=require("jquery");$(document).ready(function(){new _game.TicTacToe});
},{"./game":4,"jquery":1}],4:[function(require,module,exports){
"use strict";function _classCallCheck(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function i(i,e){for(var t=0;t<e.length;t++){var s=e[t];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(i,s.key,s)}}return function(e,t,s){return t&&i(e.prototype,t),s&&i(e,s),e}}();Object.defineProperty(exports,"__esModule",{value:!0}),exports.TicTacToe=void 0;var _player=require("./player"),$=require("jquery"),_=require("underscore"),TicTacToe=exports.TicTacToe=function(){function i(e){var t=this;_classCallCheck(this,i),this.board=$("#board"),this.positions=this.board.find("td"),this.message=$(".msg"),this.instructions=$(".instructions"),this.newGameControls=$(".new-game-controls"),this.resetControls=$(".reset-controls"),this.activeGame=!1,this.winningCombos=[[1,2,3],[4,5,6],[7,8,9],[1,4,7],[2,5,8],[3,6,9],[1,5,9],[3,5,7]],this.sides={x:'<i class="fa fa-remove"></i>',o:'<i class="fa fa-circle-o"></i>'},this.resetControls.find(".btn").on("click",function(i){t.reset()}),this.player=new _player.Player,this.ai=new _player.Player({isAI:!0}),this.newGameControls.find(".btn").on("click",function(i){t.chooseSide(i)}),this.positions.on("click",function(i){t.selectPosition(i)}),this.reset()}return _createClass(i,[{key:"reset",value:function(){this.deactivateGame(),this.resetControls.hide(),this.newGameControls.show(),this.message.html(""),this.instructions.html(""),this.positions.html("").removeClass("selected win"),this.player.reset(),this.ai.reset()}},{key:"activateGame",value:function(){this.activeGame=!0,this.board.addClass("active"),this.resetControls.show(),this.newGameControls.hide(),this.activePlayer=this.player}},{key:"deactivateGame",value:function(){this.activeGame=!1,this.board.removeClass("tie active")}},{key:"toggleActivePlayer",value:function(){this.activePlayer=this.activePlayer===this.player?this.ai:this.player}},{key:"chooseSide",value:function(i){if(!this.activeGame){var e=$(i.currentTarget);this.player.side=e.val(),this.ai.side="x"==this.player.side?"o":"x",this.activateGame(),this.instructions.html('Place an "'+this.activePlayer.side+'" in an open space by clicking or tapping on it.')}}},{key:"selectPosition",value:function(i){if(null!==this.activePlayer.side){var e=$(i.currentTarget);null===this.player.side||e.hasClass("selected")||this.markPosition(e.data("position"))}}},{key:"aiTurn",value:function(){var i={};_.each(this.winningCombinations,function(e){var t=_.intersection(e,this.player.positions),s=i[t.length],n=_.difference(e,t,this.ai.positions);n.length>0&&(void 0===s?i[t.length]=[n]:s.push(n))});var e=_.keys(i),t=parseInt(e.sort(function(i,e){return i-e})[e.length-1]),s=_.flatten(_.difference(i[t],this.player.positions,this.ai.positions)),n=void 0;if(1===t)n=1===this.player.positions.length&&5===this.player.positions[0]?_.sample(_.reject(s,function(i){return i%2===0})):_.indexOf(s,5)>-1?5:_.sample(s);else{for(var a=0;a<this.winningCombinations.length;a++){var o=this.winningCombinations[a],r=_.intersection(o,this.ai.positions),l=_.difference(o,r,this.player.positions);if(2===r.length&&1==l.length){n=l[0];break}}n||(n=s[0])}this.markPosition(n)}},{key:"markPosition",value:function(i){var e=$('[data-position="'+i+'"]');e.addClass("selected").html(this.sides[this.activePlayer.side]),this.activePlayer.positions.push(i),this.checkWinner()}},{key:"markWinningCombination",value:function(i){for(var e=0;e<i.length;e++)$('[data-position="'+i[e]+'"]').addClass("win")}},{key:"checkWinner",value:function(){for(var i=0;i<this.winningCombinations.length;i++){var e=this.winningCombinations[i];if(3===_.intersection(e,this.activePlayer.positions).length){this.activePlayer.winner=!0,this.markWinningCombination(e),this.deactivateGame(),this.message.html(this.activePlayer.fullName+" wins!");break}}(this.player.positions.length>4||this.ai.positions.length>4)&&(this.board.addClass("tie"),this.deactivateGame(),this.message.html("Tie Game"),this.instructions.html("Please try again!")),this.activePlayer.winner||(this.toggleActivePlayer(),this.activePlayer.isAI&&this.aiTurn())}}]),i}();
},{"./player":5,"jquery":1,"underscore":2}],5:[function(require,module,exports){
