...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _game=require("./game"),_game2=_interopRequireDefault(_game),_player=require("./player"),_player2=_interopRequireDefault(_player),$=require("jquery");$(document).ready(function(){var e=new _player2["default"],r=new _player2["default"]({isAI:!0,fullName:"Computer"});new _game2["default"](e,r)});
},{"./game":4,"./player":5,"jquery":1}],4:[function(require,module,exports){
"use strict";function _classCallCheck(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function i(i,e){for(var t=0;t<e.length;t++){var s=e[t];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(i,s.key,s)}}return function(e,t,s){return t&&i(e.prototype,t),s&&i(e,s),e}}();Object.defineProperty(exports,"__esModule",{value:!0});var $=require("jquery"),_=require("underscore"),TicTacToe=function(){function i(e,t){var s=this;_classCallCheck(this,i),this.board=$("#board"),this.positions=this.board.find("td"),this.message=$(".msg"),this.instructions=$(".instructions"),this.newGameControls=$(".new-game-controls"),this.resetControls=$(".reset-controls"),this.activeGame=!1,this.winningCombos=[[1,2,3],[4,5,6],[7,8,9],[1,4,7],[2,5,8],[3,6,9],[1,5,9],[3,5,7]],this.sides={x:'<i class="fa fa-remove"></i>',o:'<i class="fa fa-circle-o"></i>'},this.resetControls.find(".btn").on("click",function(i){s.reset()}),this.player=e,this.ai=t,this.newGameControls.find(".btn").on("click",function(i){s.chooseSide(i)}),this.positions.on("click",function(i){s.selectPosition(i)}),this.reset()}return _createClass(i,[{key:"reset",value:function(){this.deactivateGame(),this.resetControls.hide(),this.newGameControls.show(),this.message.html(""),this.instructions.html(""),this.positions.html("").removeClass("selected win"),this.player.reset(),this.ai.reset()}},{key:"activateGame",value:function(){this.activeGame=!0,this.board.addClass("active"),this.resetControls.show(),this.newGameControls.hide(),this.activePlayer=this.player}},{key:"deactivateGame",value:function(){this.activeGame=!1,this.board.removeClass("tie active")}},{key:"toggleActivePlayer",value:function(){this.activePlayer=this.activePlayer===this.player?this.ai:this.player}},{key:"chooseSide",value:function(i){if(!this.activeGame){var e=$(i.currentTarget);this.player.side=e.val(),this.ai.side="x"==this.player.side?"o":"x",this.activateGame(),this.instructions.html('Place an "'+this.activePlayer.side+'" in an open space by clicking or tapping on it.')}}},{key:"selectPosition",value:function(i){if(null!==this.activePlayer.side){var e=$(i.currentTarget);null===this.player.side||e.hasClass("selected")||this.markPosition(e.data("position"))}}},{key:"aiTurn",value:function(){var i=this,e={};_.each(this.winningCombos,function(t){var s=_.intersection(t,i.player.positions),n=e[s.length],a=_.difference(t,s,i.ai.positions);a.length>0&&(void 0===n?e[s.length]=[a]:n.push(a))});var t=_.keys(e),s=parseInt(t.sort(function(i,e){return i-e})[t.length-1]),n=_.flatten(_.difference(e[s],this.player.positions,this.ai.positions)),a=void 0;if(1===s)a=1===this.player.positions.length&&5===this.player.positions[0]?_.sample(_.reject(n,function(i){return i%2===0})):_.indexOf(n,5)>-1?5:_.sample(n);else{for(var o=0;o<this.winningCombos.length;o++){var r=this.winningCombos[o],l=_.intersection(r,this.ai.positions),h=_.difference(r,l,this.player.positions);if(2===l.length&&1==h.length){a=h[0];break}}a||(a=n[0])}this.markPosition(a)}},{key:"markPosition",value:function(i){var e=$('[data-position="'+i+'"]');e.addClass("selected").html(this.sides[this.activePlayer.side]),this.activePlayer.positions.push(i),this.checkWinner()}},{key:"markWinningCombination",value:function(i){for(var e=0;e<i.length;e++)$('[data-position="'+i[e]+'"]').addClass("win")}},{key:"checkWinner",value:function(){if(this.player.positions.length>4||this.ai.positions.length>4)this.board.addClass("tie"),this.deactivateGame(),this.message.html("Tie Game"),this.instructions.html("Please try again!");else for(var i=0;i<this.winningCombos.length;i++){var e=this.winningCombos[i];if(3===_.intersection(e,this.activePlayer.positions).length){this.activePlayer.winner=!0,this.markWinningCombination(e),this.deactivateGame(),this.message.html(this.activePlayer.fullName+" wins!");break}}this.activePlayer.winner||(this.toggleActivePlayer(),this.activePlayer.isAI&&this.aiTurn())}}]),i}();exports["default"]=TicTacToe;
},{"jquery":1,"underscore":2}],5:[function(require,module,exports){
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}();Object.defineProperty(exports,"__esModule",{value:!0});var Player=function(){function e(t){_classCallCheck(this,e);var r=t||{fullName:"Player 1",isAI:!1};this.fullName=r.fullName,this.isAI=r.isAI,this.reset()}return _createClass(e,[{key:"reset",value:function(){this.positions=[],this.side=null,this.winner=!1}}]),e}();exports["default"]=Player;
},{}]},{},[3])


//# sourceMappingURL=static/js/dist/app.map.json